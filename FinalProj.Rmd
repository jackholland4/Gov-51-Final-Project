...
CT_votes <- merged_CT |>
  select(town, dif_dem_voteshare, dif_rep_voteshare, rep_vote_percent_diff, dem_vote_percent_diff, votedif, `2008_dem_votes`, `2012_dem_votes`)
...
CTtwothousdata <- CTtwothousdata |>
  ...
  mutate(dem_voteshare = `Democrat votes` / total_votes)
