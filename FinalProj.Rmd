...
##subsetted plot
outlier_removed <- damaged_subset[damaged_subset$Total.Damaged..any.type. <= 500, ]
...
damage_viz <- ggplot(data = outlier_removed, aes(x = Total.Damaged..any.type., y = dem_vote_percent_diff)) +
  ...
  labs(x = "Number of Properties Damaged", y = "Dem Vote Percent Difference", title = "Property Damage vs. Democratic Vote Shift (Subsetted to Towns Damaged)") +
