...
ggplot(scatterplotdata, aes(x = Year)) +
  geom_point(aes(y = Damage), color = "blue") +
  geom_point(aes(y = `No Damage`), color = "red") +
  geom_line(aes(y = Damage), color = "lightblue", linewidth = 1) +
  geom_line(aes(y = `No Damage`), color = "pink", linewidth = 1) +
