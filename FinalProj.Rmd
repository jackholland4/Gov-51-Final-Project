...
df <- data.frame(
  ...
  Damage = c(0.5850583, 0.6150757, 0.3855000, 0.5891163, 0.5978477),
  No_Damage = c(0.5551587, 0.5766545, 0.4289768, 0.5377581, 0.4995564)
)

# Plot
ggplot(df, aes(x = Year)) +
  geom_point(aes(y = Damage), color = "blue") +
  geom_point(aes(y = No_Damage), color = "red") +
  geom_line(aes(y = Damage), color = "lightblue", size = 1) +
  geom_line(aes(y = No_Damage), color = "pink", size = 1) +
