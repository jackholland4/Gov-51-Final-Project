...
##row for percentage white non-hispanic, edited storm data
finaldata <- finaldata |>
...
#Tests
```{r}
damage_regression <- lm(dem_vote_percent_diff ~ Total.Damaged..any.type. + pct_white + votedif, data = finaldata)
...
## means of dem_vote_percent_diff for each location group

ggplot(data = damaged_subset, aes(x = Total.Damaged..any.type., y = dem_vote_percent_diff)) +
  geom_point() +
  geom_smooth(method = "lm") +
  labs(x = "Damage", y = "Dem Vote Percent Difference", title = "Property Damage vs. Dem Vote Shift") +
