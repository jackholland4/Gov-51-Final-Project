...
CT_votes <- merged_CT |>
  select(town, rep_vote_percent_diff, dem_vote_percent_diff, votedif, `2008_dem_votes`, `2012_dem_votes`)
...
##regression
regression_1 <- lm(dem_vote_percent_diff ~ Total.Damaged..any.type. + pct_white + Population + Per.capita.income + Median.household.income, data = finaldata)
summary(regression_1)


modelsummary(regression_1)
##png(file = "/Users/jackholland/Downloads/summary.PNG", width = 800, height = 600)
##print(regression_1)
